function [dstate] = vop_ODE_Part2(time, state, wEarth, re, mu, muSun, Cd, area, mass, jd_epoch, Cr, Psr)
...
%% Build dState
dstate_pert = [dh; decc; dtheta; draan; dinc; domega];
...
dstate_noPert = [dh; decc; dtheta; draan; dinc; domega];

%% Final dState

dstate = [dstate_pert;dstate_noPert];
